...
def evaluate_predictions_on_coco(
    ...
    lists = coco_eval.stats

    with open("./training_eval_curve_data/hha_ap.txt","a+") as file:  
            file.write(str(lists[1]) + "\n")

    with open("./training_eval_curve_data/hha_recall.txt","a+") as file:  
            file.write(str(lists[8]) + "\n")
